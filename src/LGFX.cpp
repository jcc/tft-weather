...
//*/
    ...
    { // タッチスクリーン制御の設定を行います。（必要なければ削除）
      ...
      cfg.y_max      = 279;  // タッチスクリーンから得られる最大のY値(生の値)
...
// SPI接続の場合
      ...
      cfg.pin_sclk = 5;     // SCLKが接続されているピン番号
      cfg.pin_mosi = 18;     // MOSIが接続されているピン番号
...
// I2C接続の場合
      ...
      cfg.pin_sda  = 16;     // SDAが接続されているピン番号
      cfg.pin_scl  = 15;     // SCLが接続されているピン番号
